...
# ═══════════════════════════════════════════════════════════════════════════════
# 📊 FIXED PERFORMANCE ANALYSIS - Proper Indentation & 9 Points
# ═══════════════════════════════════════════════════════════════════════════════
# 🎯 This goes INSIDE the "if generate_analysis:" block in Part 7a
            ...
            avg_fan_profit = sum(all_fan_profits) / len(all_fan_profits)
            total_sessions = len(SPX_SLOTS)
            blended_profit = (9 + avg_fan_profit) / 2  # Fixed: 9 instead of 8.5
            ...
            with col1:
                ...
                <div style="background: rgba(34, 197, 94, 0.1); border-radius: 12px; padding: 1.5rem; text-align: center; border: 1px solid rgba(34, 197, 94, 0.2);">
                    <div style="font-size: 2rem; font-weight: bold; color: #22c55e;">+9</div>
